...
class Data_CargosController extends Zend_Rest_Controller
{
    ...
    public function putAction()
    {
        ...
        if(($this->getRequest()->isPut())){
            try{
                ...
                $id=$formData['id'];
                unset($formData['id']);
                $cargos_table->update($formData, "id=$id");
                $this->view->msg = "Dados atualizados com sucesso!";
                $obj = $cargos_table->fetchRow("id=$id");
    ...
    public function postAction()
    {
        ...
        if($this->getRequest()->isPost()){
            try{
                ...
                $id = $cargos_table->insert($formData);
