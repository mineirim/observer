...
jsonb_array_elements(propriedades->'files')->'nome' nome,  jsonb_array_elements(propriedades->'files') anexo   FROM programacoes WHERE projeto_id=:projetoId AND propriedades->'files' IS NOT NULL";
